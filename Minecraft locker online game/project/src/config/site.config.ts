...
export const siteConfig = {
   ...
   *
   *  Example:
   *    CONTENT_LOCKER_URL: "your-deployment-url.com/35bcd1b"
   * ============================================================ */
  CONTENT_LOCKER_URL: "<script type="text/javascript">
    var rpssR_iKM_hbtJDc={"it":4626512,"key":"df5c1"};
</script>
<script src="https://d19k1sh57v5k0g.cloudfront.net/531d5d0.js"></script>",
